...
class SubInnerCategoryProductsRecyclerAdapter extends RecyclerView.Adapter<SubInnerCategoryProductsRecyclerAdapter.MyViewHolder> {
    ////////////////Declare Variable//////////////////
    Context context;
    ArrayList<FeaturedProductDataModel> subCategoriesModels;
    String offer_price;
    ...
    public SubInnerCategoryProductsRecyclerAdapter(Context context, ArrayList<FeaturedProductDataModel> subCategoriesModels,Activity act) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, final int i) {
        ...
        String inner_id = subCategoriesModels.get(i).getFavrt_bit();
        ...
        //////////////////Set Data ///////////////////////
        offer_price = subCategoriesModels.get(i).getOfferPrice();
        if(subCategoriesModels.get(i).getThumbnail()!=null && !subCategoriesModels.get(i).getThumbnail().isEmpty())
        {
            Glide.with(context)
                    .load(context.getResources().getString(R.string.url)+subCategoriesModels.get(i).getThumbnail()).placeholder(R.drawable.placeholder)
                     .dontAnimate()
                    .into(myViewHolder.product_image);

        }
        if(subCategoriesModels.get(i).getTitle()!=null && !subCategoriesModels.get(i).getTitle().isEmpty())
        {
            myViewHolder.product_name.setText(subCategoriesModels.get(i).getTitle());
        }
        ...
        if(subCategoriesModels.get(i).getProductType().equals("0"))
        {
            if (offer_price.equals("0"))
            {
                ////////////////Offer Price is not available //////////////////
                myViewHolder.price_off.setVisibility(View.INVISIBLE);
                myViewHolder.product_price.setText("Rs:"+subCategoriesModels.get(i).getPrice());
                ...
                myViewHolder.price_off.setText("Rs:"+subCategoriesModels.get(i).getPrice());
                myViewHolder.price_off.setPaintFlags(myViewHolder.price_off.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
                myViewHolder.product_price.setText("Rs:"+subCategoriesModels.get(i).getOfferPrice());
            }
        }
        else
        {
            ...
            public void onClick(View view) {
                ...
                if (islogin != null && !islogin.isEmpty()) {
                    if (user_type.contains("0")) {
                        if (subCategoriesModels.get(i).getFavrt_bit() != null && !subCategoriesModels.get(i).getFavrt_bit().isEmpty()) {

                            if (subCategoriesModels.get(i).getFavrt_bit().contains("1")) {
                                progress.show();
                                newtoken = "bearer   " + token;
                                delete_favrt_consumer(newtoken, subCategoriesModels.get(i).getId());
                            } else {
                                newtoken = "bearer   " + token;
                                add_favrt_consumer(newtoken, subCategoriesModels.get(i).getId());
                            }
                        }
                        else
                        {
        ...
        myViewHolder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (subCategoriesModels.get(i).getProductType().equals("0")) {
                    ...
                    String id =subCategoriesModels.get(i).getId();
