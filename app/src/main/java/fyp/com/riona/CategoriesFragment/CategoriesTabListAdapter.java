...
public class CategoriesTabListAdapter  extends RecyclerView.Adapter<CategoriesTabListAdapter.MyViewHolder>{
   ...
   ArrayList<CategoryDataModel> dataModelArrayList;
    ...
    public CategoriesTabListAdapter(Context context, ArrayList<CategoryDataModel> dataModelArrayList) {
    ...
    @NonNull
    @Override
    public CategoriesTabListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CategoriesTabListAdapter.MyViewHolder myViewHolder, final int i) {
